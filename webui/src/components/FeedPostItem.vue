...
<div>
  ...
  <div class="card">
			...
			<div class="card-body">
				...
				<div class="in_a_row">
				<btn @click="sendToComments()" class="btn btn-outline-success btn-sm">Comments</btn>
				...
				<btn v-else @click="deletePostLike()" class="btn btn-outline-danger btn-sm"><i class="bi bi-hand-thumbs-up-fill"></i></btn>
				...
				<btn v-else @click="deletePostDislike()" class="btn btn-outline-danger btn-sm"><i class="bi bi-hand-thumbs-down-fill"></i></btn>
