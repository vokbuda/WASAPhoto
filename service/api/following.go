...
func (rt *_router) following(w http.ResponseWriter, r *http.Request,
	...
	var followingUsers []database.SimpleClient

	followingUsers, err = rt.db.Following(uidQuery, offset, uid)
	...
	_ = json.NewEncoder(w).Encode(followingUsers)
