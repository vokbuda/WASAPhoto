...
// below u will implement data for unfollow user inside your database
func (rt *_router) unfollowUser(w http.ResponseWriter, r *http.Request,
	...
	err = rt.db.UnfollowUser(subscription.FollowedUserId, subscription.FollowingUserId)
